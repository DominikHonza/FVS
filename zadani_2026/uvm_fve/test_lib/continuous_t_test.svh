...
class continuous_t_test extends timer_t_test_base;

    // registration of component tools
    `uvm_component_utils( continuous_t_test )

    uvm_sequence_base seq;
    // Constructor - creates new instance of this class
    function new( string name = "continuous_t_test", uvm_component parent = null );
    ...
    // Configures CONTINOUS mode and lets the timer run long enough to generate IRQ.
