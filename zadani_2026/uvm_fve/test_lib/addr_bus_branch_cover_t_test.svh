class addr_bus_branch_cover_t_test extends timer_t_test_base;

    `uvm_component_utils(addr_bus_branch_cover_t_test)

    function new(string name = "addr_bus_branch_cover_t_test", uvm_component parent = null);
...
endclass: addr_bus_branch_cover_t_test
