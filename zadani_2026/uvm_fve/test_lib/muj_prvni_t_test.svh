...
class muj_prvni_t_test extends timer_t_test_base;

    // registration of component tools
    `uvm_component_utils( muj_prvni_t_test )

    uvm_sequence_base seq;
    // Constructor - creates new instance of this class
    function new( string name = "muj_prvni_t_test", uvm_component parent = null );
    ...
    // Runs a simple smoke flow through reset and all direct mode-setting sequences.
