...
class mode_transition_t_test extends timer_t_test_base;

    // registration of component tools
    `uvm_component_utils( mode_transition_t_test )

    uvm_sequence_base seq;
    // Constructor - creates new instance of this class
    function new( string name = "mode_transition_t_test", uvm_component parent = null );
    ...
    // Configures CONTINOUS mode after setup and lets it run as a mode-transition scenario.
    task run_phase(uvm_phase phase);
        ...
        // 3. CONTINUOUS
        mode_seq = timer_t_sequence_CONTINOUS::type_id::create("continuous_seq");
...
endclass: mode_transition_t_test
