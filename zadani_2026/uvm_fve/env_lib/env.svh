...
class timer_t_env extends uvm_env;
    ...
    function void build_phase( uvm_phase phase );
        ...
        m_timer_reg_block = timer_reg_block::type_id::create("timer_reg_block");
        m_timer_reg_block.configure();
        m_timer_reg_block.build();

        m_timer_reg_block.lock_model();
    ...
    function void connect_phase( uvm_phase phase );
        ...
        m_timer_reg_block.default_map.set_sequencer(m_timer_t_agent_h.m_sequencer_h,m_reg_adapter);
        m_timer_reg_block.default_map.set_auto_predict(0);
        m_timer_reg_block.default_map.set_check_on_read(1);
